...
{{--    {{ Html::script(asset('js/plugins/pace-loader.js')) }}--}}
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCxzsBDvUHrptjCDFs3UWbNpxpvTHkGXUI&amp;callback=initMap" async defer></script><script src="js/plugins/gmaps-ini.js"></script>
