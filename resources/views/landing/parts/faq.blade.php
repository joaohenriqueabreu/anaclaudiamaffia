        ...
        <div class="text-center g-max-width--700 g-margin-side-auto">
            <div class="twi-feed">
                ...
                <div class="twi">
                    ...
                    <em class="twi__date">
                        A consultoria é um trabalho mais rápido e direcionado, em que conversamos sobre todas as
                        necessidades do espaço, mas a execução fica por conta do cliente. Já o cliente que opta por
                        contratar o projeto completo, receberá o pacote completo com imagens e detalhamento de execução,
                        acompanhamento de orçamento e contratação de fornecedores, auxílio com dúvidas, acompanhamento
                ...
                <div class="twi">
                    ...
                    <blockquote class="twi__tweet g-mb-30">
                        Mas e se depois da consultoria eu tiver dificuldade em executar algum serviço ou comprar algum
                        item?
                    </blockquote>
                    <em class="twi__date">
                        Se depois da entrega do material da consultoria você ainda tiver alguma dificuldade e achar
                        necessário podemos combinar um pacote específico para a sua dúvida. Por exemplo, podemos
                        acompanhá-lo em lojas e fornecedores para escolha de móveis e adornos, podemos enviar desenhos
                        para execução de marcenaria, podemos desenvolver imagens 3D para que você veja as alterações
                        propostas em seu espaço, etc. Não se preocupe, o objetivo é você ficar 100% satisfeito e seguro
                ...
                <div class="twi">
                    ...
                    <em class="twi__date">
                        Vamos conversar e entender suas necessidades, assim poderemos te indicar a melhor opção. Entre
                ...
                <div class="twi">
                    ...
                    <em class="twi__date">
                        ...
                        surpreendido. Com todas as informações em mãos, será mais fácil planejar sua obra não é
                        mesmo? E fique tranquilo, nosso objetivo é ver seu projeto executado, e por isso, deverá atender sua expectativa
                        de custo e prazo para a obra!
                    </em>
                </div>
                <div class="twi">
                    <div class="g-heading-v7 text-center g-mb-70">
